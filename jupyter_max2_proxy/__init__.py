...
def _max2_mappath(path):

    # always pass the url parameter
    if path in ('/', '/index.html', ):
        url_params = _max2_urlparams()
...
def setup_max2():
    ...
    global _max2_passwd, _max2_aeskey
    ...
    _max2_aeskey = _get_random_alphanumeric_string(16)
    try:
    ...
    path_info = 'max2/index.html' + _max2_urlparams()
    ...
    return {
        ...
        'command': cmd,
        'mappath': _max2_mappath,
        'absolute_url': False,
        'timeout': 90,
        'new_browser_tab': True,
        'launcher_entry': {
            'enabled': True,
            'icon_path': os.path.join(HERE, 'icons/max2-logo.svg'),
            'title': 'Max2',
            'path_info': path_info,
        },
    }
